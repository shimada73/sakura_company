 ...
 *	www.frebsite.nl
 */
function(t){var i="tosrus",e="image";t[i].media[e]={filterAnchors:function(i){return t.inArray(i.attr("href").toLowerCase().split(".").pop().split("?")[0],["jpg","jpe","jpeg","gif","png","bmp","webp"])>-1},initAnchors:function(e,s){t('<img border="0" />').on(t[i]._e.load,function(s){s.stopPropagation(),e.removeClass(t[i]._c.loading).trigger(t[i]._e.loaded)}).appendTo(e).attr("src",s)},filterSlides:function(t){return t.is("img")},initSlides:function(t){}},t[i].defaults.media[e]={}}(jQuery),/*	
 * jQuery Touch Optimized Sliders "R"Us
 * Vimeo media
 *
 *	Copyright (c) Fred Heusschen
