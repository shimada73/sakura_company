...
<li>
<p class="control-title"><?php printf( __( 'Setting of %s', 'luxeritas' ), __( 'default OGP image', 'luxeritas' ) ); ?></p>
<p class="f09em"><?php echo __( '* When OGP image is not set in the post, the default image set here will be applied.', 'luxeritas' ); ?></p>
<?php
	//global $luxe;
