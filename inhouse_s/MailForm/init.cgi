...
# 送信先メールアドレス
$cf{mailto} = 'soumu@sakura-communication.co.jp';

# sendmailのパス【サーバパス】
# → プロバイダの指定を確認のこと
$cf{sendmail} = '/usr/lib/sendmail -t -fsoumu@sakura-communication.co.jp';
...
# メール件名（初期値）
$cf{subject} = '【報告】勤怠管理フォームに投稿があります。';
...
# 返信向けメールタイトル
$cf{sub_reply} = '【報告】勤怠管理フォームへの投稿が完了しました。';
...
# 送信後の戻り先【URLパス】
$cf{back} = 'https://www.sakura-communication.co.jp/inhouse_s/indexS.html';
